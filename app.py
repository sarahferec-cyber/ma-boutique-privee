...
st.markdown(
    ...
    <div style="background-color:#f9f9f9; padding:15px; border-radius:5px; font-size:12px; color:#555555;">
        ...
        <p style="margin-bottom:5px;"><strong>Éditeur du site :</strong> Site géré par <strong>Sarah Ferec</strong> (Mes Bons Plans de Sarah), domiciliée à <strong>Aigues-Vives</strong>, exploitée sous le statut légal de la <strong>micro-entreprise</strong> (Numéro SIRET / SIREN : En cours d'immatriculation). Ce site ne constitue pas une boutique marchande en ligne automatisée : il s'agit d'un outil de visualisation de catalogue et de réservation de stocks physiques.</p>
        <p style="margin-bottom:5px;"><strong>Régime fiscal :</strong> TVA non applicable, article 293 B du Code Général des Impôts (CGI).</p>
